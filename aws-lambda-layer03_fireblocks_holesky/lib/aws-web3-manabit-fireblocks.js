...
const fb_keyName = process.env.SSM_FBKEY_NAME
...
const fireblocks_path_key = 'lib/fireblocks_secret_holesky.key'
...
async function init_ENV() {
    try{
        ...
        const fb_apiSecret = await SecretsManager.getSecret(fb_keyName, region);
